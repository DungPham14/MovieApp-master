 ...
 * hiển thị tab phim nhiều người xem nhất
 */
...
public class MostPopular extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable
            ViewGroup container, @Nullable Bundle saveInstanceState) {

        View rootView = inflater.inflate(R.layout.most_popular, container, false);
